...
rpConf.reportPortalClientConfig.token;
...
exports.config = {
    ...
    capabilities: [{
        ...
        'goog:chromeOptions': {
            'w3c': false,
            // 'disable-gpu', 'headless' , '--disable-notifications'
    ...
    services: ['chromedriver', [RpService, {}], 'intercept', 'devtools'], //, 'intercept'
    ...
    afterTest: function (test, context, {error, result, duration, passed, retries}) {
        if (error !== undefined) {
            reportportal.sendFileToTest(test, 'info', test.title, browser.takeScreenshot());
        }
    },
    /**
